...
type TToastType = "success" | "error" | "warning" | "default";

export const ToastType = {
  SUCCESS: "success" as TToastType,
  ERROR: "error" as TToastType,
  WARNING: "warning" as TToastType,
  DEFAULT: "default" as TToastType,
};

export const useToastCustom = () => {
  return (message: string, type: TToastType = "default") => {
